...
for k = [1:13,27:39]
%     wholeData(k).avg_pli = permute(wholeData(k).avg_pli,[2 3 1]);
%     wholeData(k).pli_zmap = permute(wholeData(k).pli_zmap,[2 3 1]);
%     wholeData(k).pli_zmap_corrected = permute(wholeData(k).pli_zmap_corrected,[2 3 1]);
%     wholeData(k).avg_pli = abs(wholeData(k).avg_pli);
%     wholeData(k).pli_zmap = abs(wholeData(k).pli_zmap);
end
...
baselinecorrectedFieldName = 'pli_zmap';
...
spssStructure(k).(dat1names{2}) = spssStructure(k).(dat1names{2})-eye(8,8);
spssStructure_z(k).(dat1names{2}) = spssStructure_z(k).(dat1names{2})-eye(8,8);
end

for k = 1:length(spssStructure2)
spssStructure2(k).(dat2names{2}) = spssStructure2(k).(dat2names{2})-eye(8,8);
spssStructure2_z(k).(dat2names{2}) = spssStructure2_z(k).(dat2names{2})-eye(8,8);
end

for k = 1:length(spssStructure3)
spssStructure3(k).(dat3names{2}) = spssStructure3(k).(dat3names{2})-eye(8,8);
spssStructure3_z(k).(dat3names{2}) = spssStructure3_z(k).(dat3names{2})-eye(8,8);
end

% for k = 1:length(spssStructure_all)
% spssStructure_all(k).(dat4names{2}) = spssStructure_all(k).(dat4names{2})-eye(8,8);
% spssStructure_all_z(k).(dat4names{2}) = spssStructure_all_z(k).(dat4names{2})-eye(8,8);
% end
...
for k = 1:13
    subplot(4,4,k)
    imagesc(spssStructure(k).(dat1names{2})); axis xy
    yticks(1:8)
    xticks(1:8)
...
for k = 1:13
    subplot(4,4,k)
    imagesc(spssStructure2(k).(dat2names{2})); axis xy
    yticks(1:8)
    xticks(1:8)
    xticklabels({'F3','F4','C3','C4','P3', 'P4','O1', 'O2'});
    yticklabels({'F3','F4','C3','C4','P3', 'P4','O1', 'O2'});
...
for k = 1:13
    subplot(4,4,k)
    imagesc(spssStructure3(k).(dat3names{2})); axis xy
    yticks(1:8)
    xticks(1:8)
    xticklabels({'F3','F4','C3','C4','P3', 'P4','O1', 'O2'});
    yticklabels({'F3','F4','C3','C4','P3', 'P4','O1', 'O2'});
...
for k = 1:13
    subplot(4,4,k)
    imagesc(spssStructure_z(k).(dat1names{2})); axis xy
    yticks(1:8)
    xticks(1:8)
    xticklabels({'F3','F4','C3','C4','P3', 'P4','O1', 'O2'});
    yticklabels({'F3','F4','C3','C4','P3', 'P4','O1', 'O2'});
...
for k = 1:13
    subplot(4,4,k)
    imagesc(spssStructure2_z(k).(dat2names{2})); axis xy
    yticks(1:8)
    xticks(1:8)
    xticklabels({'F3','F4','C3','C4','P3', 'P4','O1', 'O2'});
    yticklabels({'F3','F4','C3','C4','P3', 'P4','O1', 'O2'});
...
for k = 1:13
    subplot(4,4,k)
    imagesc(spssStructure3_z(k).(dat3names{2})); axis xy
    yticks(1:8)
    xticks(1:8)
    xticklabels({'F3','F4','C3','C4','P3', 'P4','O1', 'O2'});
    yticklabels({'F3','F4','C3','C4','P3', 'P4','O1', 'O2'});
...
figure(7)
%early
data = nonzeros(cat(3,spssStructure(1:13).(dat1names{2})));

data2 = nonzeros(cat(3,spssStructure(14:26).(dat1names{2})));
% mean
% data = mean(nonzeros(cat(3,spssStructure(1:13).(dat1names{2}))),3);
% 
% data2 = mean(nonzeros(cat(3,spssStructure(14:26).(dat1names{2}))),3);
...
set(gca,'xlim',[0.1 0.6])
%middle
data = nonzeros(cat(3,spssStructure2(1:13).(dat2names{2})));

data2 = nonzeros(cat(3,spssStructure2(14:26).(dat2names{2})));
% mean
% data = mean(nonzeros(cat(3,spssStructure2(1:13).(dat2names{2}))),3);
% 
% data2 = mean(nonzeros(cat(3,spssStructure2(14:26).(dat2names{2}))),3);
...
%late
data = nonzeros(cat(3,spssStructure3(1:13).(dat3names{2})));
data2 = nonzeros(cat(3,spssStructure3(14:26).(dat3names{2})));

% mean
% data = mean(nonzeros(cat(3,spssStructure3(1:13).(dat3names{2}))),3);
% 
% data2 = mean(nonzeros(cat(3,spssStructure3(14:26).(dat3names{2}))),3);
subplot(3,2,5)
hist(data)
hold on
plot([median(data) median(data)],ylim(gca),'k')
...
%early
data = nonzeros(cat(3,spssStructure_z(1:13).(dat1names{2})));
data2 = nonzeros(cat(3,spssStructure_z(14:26).(dat1names{2})));

data = mean((cat(3,spssStructure_z(1:13).(dat1names{2}))),3);
data2 = mean((cat(3,spssStructure_z(14:26).(dat1names{2}))),3);
...
set(gca,'xlim',clims)
%middle
data = nonzeros(cat(3,spssStructure2_z(1:13).(dat2names{2})));
data2 = nonzeros(cat(3,spssStructure2_z(14:26).(dat2names{2})));

data = mean((cat(3,spssStructure2_z(1:13).(dat2names{2}))),3);
data2 = mean((cat(3,spssStructure2_z(14:26).(dat2names{2}))),3);
% stddata = (std(data)/sqrt(length(data)))*norminv(1-(0.05/168));
stddata = (std(data))*norminv(1-(0.05/28));
dataCI = mean(data)+stddata;
...
%late
data = nonzeros(cat(3,spssStructure3_z(1:13).(dat3names{2})));
data2 = nonzeros(cat(3,spssStructure3_z(14:26).(dat3names{2})));


data = mean((cat(3,spssStructure3_z(1:13).(dat3names{2}))),3);
data2 = mean((cat(3,spssStructure3_z(14:26).(dat3names{2}))),3);
% stddata = (std(data)/sqrt(length(data)))*norminv(1-(0.05/168));
stddata = (std(data))*norminv(1-(0.05/28));
dataCI = mean(data)+stddata;
...
%early
olderData_early = mean(cat(3,spssStructure(1:13).(dat1names{2})),3);
youngData_early = mean(cat(3,spssStructure(14:26).(dat1names{2})),3);

olderData_early = triu(olderData_early)+triu(olderData_early,1)';
youngData_early = triu(youngData_early)+triu(youngData_early,1)';

%middle
olderData_middle = mean(cat(3,spssStructure2(1:13).(dat2names{2})),3);
youngData_middle = mean(cat(3,spssStructure2(14:26).(dat2names{2})),3);

olderData_middle = triu(olderData_middle)+triu(olderData_middle,1)';
youngData_middle = triu(youngData_middle)+triu(youngData_middle,1)';

%late
olderData_late = mean(cat(3,spssStructure3(1:13).(dat3names{2})),3);
youngData_late = mean(cat(3,spssStructure3(14:26).(dat3names{2})),3);

olderData_late = triu(olderData_late)+triu(olderData_late,1)';
youngData_late = triu(youngData_late)+triu(youngData_late,1)';

allData = {olderData_early, youngData_early, olderData_middle,youngData_middle,olderData_late,youngData_late};

%% for thresholding 
%early 
olderData_earlyz = mean(cat(3,spssStructure_z(1:13).(dat1names{2})),3);
youngData_earlyz = mean(cat(3,spssStructure_z(14:26).(dat1names{2})),3);
...
%middle 
olderData_middlez = mean(cat(3,spssStructure2_z(1:13).(dat2names{2})),3);
youngData_middlez = mean(cat(3,spssStructure2_z(14:26).(dat2names{2})),3);
...
%late 
olderData_latez = mean(cat(3,spssStructure3_z(1:13).(dat3names{2})),3);
youngData_latez = mean(cat(3,spssStructure3_z(14:26).(dat3names{2})),3);
...
timeText = {'t1: 0-250ms','t1: 0-250ms','t2: 250-500ms','t2: 250-500ms','t3: 500-750ms','t3: 500-750ms'};
%% matrix plot
