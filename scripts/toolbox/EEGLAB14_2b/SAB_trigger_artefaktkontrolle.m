function [vp, data] = SAB_trigger_artefaktkontrolle (vp_bez, sweepl, wastun, kanal_a,kanal_p, f_thresh, m_thresh, fenster)
%
...
% 
% Beispiel:
% [vp, data] = artefakt_SAB_trigger ('up023K14_3000_1000', 'odk_minus6000_bis_1000', 'festundmuskel', [1:9,11,12],[10,14], 80, 80,[-1000 1000]);
% 
% Ausgabe: 
